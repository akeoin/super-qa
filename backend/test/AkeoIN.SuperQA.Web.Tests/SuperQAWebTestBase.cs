...
{
    public abstract class SuperQAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SuperQAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SuperQAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SuperQADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SuperQADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SuperQADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SuperQADbContext, Task<T>> func)
        {
            T result;
